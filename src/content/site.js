...
export const site = {
  ...
  now: [
    "Building agentic retrieval systems.",
    "Serving models at scale without the bill running away.",
    "Open to architecture reviews and hard problems.",
  ],
  email: "",
  links: {
    github: "https://github.com/s-maharajan",
    linkedin: "",
    resume: "",
  },
};
